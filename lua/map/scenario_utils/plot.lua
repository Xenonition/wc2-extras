...
function add_plot(scenario, scenario_num, nplayers)
	...
	elseif scenario_num == 2 then
		...
		start_message(ai1, true, _ "What’s this?! Foreign invaders have set foot upon our shores!")
		start_message(ai2, true, _ "We’ll send them back to where they came from quick enough. All troops, to me!")
	...
	elseif scenario_num == 3 then
		start_message(ai1, true, _ "What’s this? It is a long time since strangers have set foot upon Moragdu — and in such great numbers too!")
		start_message(ai2, true, _ "The time of prophecies is upon us! The destroyers have arrived from beyond the sea!")
		start_message(ai3, true, _ "I don’t know what the lizard is babbling about, but we’ll sort these ‘destroyers’ out quickly enough.")
